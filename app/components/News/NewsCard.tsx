  ...
  const newsData = [
    {
      ...
      detail: "Prague is well known for its rich history, especially Medieval era. During MMM 2026, we invite you to explore Prague is well known for its rich history, especially Medieval era. During MMM 2026, we invite you to explore...",
